...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		desktop: [
			"assets/images/DesktopWallpaper/F3.avif",
			"assets/images/DesktopWallpaper/F4.avif",
			"assets/images/DesktopWallpaper/F5.avif",
			"assets/images/DesktopWallpaper/F6.avif",
			"assets/images/DesktopWallpaper/F7.avif",
		],
		// 移动背景图片（支持单张或多张随机）
